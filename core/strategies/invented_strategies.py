...
def vol_regime_switch_strategy(data: pd.DataFrame, **kwargs): # Adicionado **kwargs
...
def meta_ensemble_strategy(data: pd.DataFrame, **kwargs): # Adicionado **kwargs
...
def pullback_trend_bias_strategy(data: pd.DataFrame, **kwargs): # Adicionado **kwargs
    close_prices = data['Close']
    low_prices = data['Low']
