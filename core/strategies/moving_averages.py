...
# Parâmetros default (pode manter os seus)
...
def ema_crossover_strategy(df: pd.DataFrame, params: dict) -> pd.DataFrame:
    ...
    # CORREÇÃO: Usar df_s['Close'] para garantir que é 1-dimensional
    ...
    # Preenche stop/target (pode ser mais sofisticado)
