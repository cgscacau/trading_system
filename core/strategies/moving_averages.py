...
SMA_CROSSOVER_PARAMS = {'sma_short': 20, 'sma_long': 50}
...
def sma_crossover_strategy(df: pd.DataFrame, params: dict) -> pd.DataFrame:
    ...
    sma_short = ta.trend.sma_indicator(df_s['Close'], window=params.get('sma_short', 20))
    sma_long = ta.trend.sma_indicator(df_s['Close'], window=params.get('sma_long', 50))
